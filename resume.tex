...
\vspace*{-14mm}
\section{About Me}{
I’m a software architect with more than 20 years of experience, specialized in cloud computing, promoter of operational excellence, security, infrastructure as code, and automation. I love to work in diverse and globally distributed teams. I wake in the morning because there are problems to be solved.
}
\section{Relevant Experience}
\cventry{May 2021 Current}{Principal Software Engineer}{Remote, France}{Trimble Solutions Corporation}{}{
I worked in a distributed team building cloud solutions for the Tekla customers.
\begin{itemize}
\item Created an interoperability layer between the Trimble identity service and the legacy Tekla desktop applications, built with AWS, SAM, .NET Core and C\#.
...
I worked in a distributed team building cloud solutions for Tekla customers.
\begin{itemize}
...
Participated to the development of a Nintendo Switch emulator written in C\#.
}
